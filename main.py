...
def practica_punto_2():
    ...
    print(estudiantes_fisica.intersection(estudiantes_matematicas))
    
    #Muestra los estudiantes que están en matemáticas pero no en física.
    print(estudiantes_matematicas.difference(estudiantes_fisica))

    #Muestra la unión de estudiantes.
    print(estudiantes_matematicas.union(estudiantes_fisica))

    #Muestra los estudiantes que están solo en una de las dos clases.
    print(estudiantes_fisica.symmetric_difference(estudiantes_matematicas))
...
def practica_punto_4():
    ...
    parrafo = input("Ingrese su parrafo de texto: ").lower()
